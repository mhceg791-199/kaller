        ...
        <div className="story-card relative flex flex-col lg:flex-row items-center gap-6 md:gap-10">
          <div className="w-full lg:w-1/2 lg:text-right">
            <p className="text-gray-300 md:text-gray-400 text-base md:text-lg leading-relaxed">
              It began with a belief: architecture is never just about structure
              — it is about responsibility. Every line drawn shapes how people
              live, work, and gather. Every building contributes to the story of
              a city.
            </p>
          </div>
