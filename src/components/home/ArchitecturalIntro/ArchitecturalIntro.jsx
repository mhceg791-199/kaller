...
const IntroductionSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="hidden lg:block lg:col-span-1 h-full min-h-[400px] relative">
          ...
          <div ref={lineRef} className="absolute left-1/2 top-0 w-[1px] bg-mainGold" />
        </div>
        ...
        <div className="lg:col-span-6 space-y-12">
          <p className="reveal-text text-lg md:text-xl text-gray-300 font-light leading-relaxed border-r-2 border-mainGold/20 pr-8">
            Founded in 1984, <strong className="text-white">Kaller Architecture</strong> has shaped the evolving landscape of South Florida through disciplined design, technical precision, and enduring partnerships.
          </p>

          <p className="reveal-text text-gray-400 leading-relaxed font-light">
            For over four decades, our firm has delivered residential towers, retail centers, hospitality destinations, civic buildings, and mixed-use developments that balance <span className="text-white italic">creativity with constructability</span>.
          </p>
          ...
          <div className="reveal-text bg-white/5 p-8 border border-white/10 backdrop-blur-sm relative group overflow-hidden">
            ...
            <p className="text-sm md:text-base text-gray-300 leading-relaxed italic">
              Today, as a proud subsidiary of <span className="text-mainGold font-bold">Mosaic Holding Corporation</span>, Kaller combines deep local expertise with the strength of an international network.
            </p>
          </div>
